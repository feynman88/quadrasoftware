...
const services = [
  {
    title: "برمجيات مخصصة",
    description:
      "نقوم بتطوير حلول برمجية مخصصة تلبي احتياجات عملك الفريدة، بما في ذلك تطبيقات سطح المكتب، أدوات التشغيل الآلي، وأنظمة الإدارة.", // {{ edit_2 }}
  ...
  },
  {
    title: "أنظمة ERP",
    description:
      "تصميم وتنفيذ أنظمة ERP متكاملة لإدارة موارد الشركة بكفاءة، تشمل تخطيط الموارد، إدارة المشاريع، وإعداد التقارير المالية.", // {{ edit_4 }}
    icon: CubeIcon,
    href: "/erp",
  },
  {
    ...
    description:
      "تطوير تطبيقات ويب وتطبيقات هاتف محمول تفاعلية وسهلة الاستخدام، توفر تجربة استخدام سلسة على جميع الأجهزة والمنصات.", // {{ edit_6 }}
  ...
  },
  {
    ...
    description:
      "بناء وتطوير منصات تجارة إلكترونية متكاملة تشمل بوابات الدفع، إدارة المخزون، والتسويق الإلكتروني لزيادة المبيعات.", // {{ edit_8 }}
  ...
  return (
    <>
      ...
      <div
        style={{
          background:
            "radial-gradient(circle at top, #204878 0%, #121c27 43%, #000000 100%)",
          padding: "20px",
        }}
      >
        {" "}
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  نقدم لك أفضل الحلول البرمجية لتطوير أعمالك وتنمية مشاريعك. نحن
                  نتخصص في تصميم وتطوير المواقع الإلكترونية، التطبيقات، والحلول
                  البرمجية المبتكرة التي تناسب احتياجاتك الفريدة
                </p>
      ...
      <section className="py-16 mb-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-gray-600">لدينا واسعة من الخدمات</p>
          </div>
